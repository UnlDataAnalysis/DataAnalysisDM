...
participant_questions1 = pd.read_csv("exportData1.csv", skiprows=4)
participant_questions2 = pd.read_csv("exportData2.csv", skiprows=4)
participant_questions3 = pd.read_csv("exportData3.csv", skiprows=4)
participant_questions4 = pd.read_csv("exportData4.csv", skiprows=4)
